...
*Algo em que você se destacou, seja técnico ou comportamental*   
    ...
    Aprendizagem rápida sem a necessidade de ficar muitas horas além da aula;
    Aprendo muitos com os meus erros, quando erro uma vez raramente cometo o mesmo erro;
    Facilidade em entender e aplicar a lógica de programção;
    Liderar a equipe;
    Trabalho em equipe;
    Aprender coisas novas fora da aula.
...
*Algo em que você considera que tenha ido bem, mas que de alguma forma tenha aptidão de melhorar, seja técnico ou comportamental*
    ...
    Revisar alguns assuntos para melhor entendimento.
...
*De uma forma geral, comentar e destacar alguma característica ou habilidade que tenha desenvolvido durante as aulas e que julgue que possa ser útil para uma empresa, que possa agregar valor a seu curriculo*
    ...
    Melhorei minha organização do tempo;
    Melhorei meu raciocínio lógico;
    Melhorei minha comunicação com os colegas;
    Melhorei minha agilidade no desenvolvimento.
...
1. Você já sabia programar, se sim, quais linguagens? 
    ...
    Não, mas já tinha contato com algumas linguagens e com programadores

2. Você fez algum curso na área ou está cursando, se sim qual curso (Curso livre, Técnico, Nível superiror, etc)?

    Não, estou estudando somente no Entra21
